...
/**
 * create_xarray - creates artray of chars and initializes it with the character 'x'.
 * @size: size of an initialized array
 *
 ...
 * @argv: the number of arg passed to the program
 * @argc: the number of arg passed
 *
 * Description: if the number of arg is incorrect or one num contains non-digits, the function exits with a status of 98
 * Return: always 0.
 */
